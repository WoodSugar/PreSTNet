...
from main.main_arch.head import TMetaConvSConvHeaderNewPeMS03
from main.main_arch.backbone import PreTrainEncoderDecoder


CFG = EasyDict()
# ================= general ================= #
CFG.DESCRIPTION = "FineTune(MyPeMS03) configuration"
CFG.RUNNER = ForecastRunner
CFG.DATASET_CLS = ForecastDataset
CFG.DATASET_NAME = "PeMS03New"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "NewPeMS03EnPropose_DeTMetaConvSConv"
...
from model_setting.pre_train.NewPeMS03Propose import CFG as BackBone

CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "backbone_path": "backbone_pt/NewPeMS03_PreTrain.pt",
    
    "backbone_model": PreTrainEncoderDecoder,
    "backbone_args": BackBone.MODEL.PARAM,
        
    "predictor_model": TMetaConvSConvHeaderNewPeMS03, 
    "predictor_args": {
