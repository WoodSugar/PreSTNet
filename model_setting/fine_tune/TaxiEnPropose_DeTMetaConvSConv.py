...
CFG = EasyDict()
# ================= general ================= #
CFG.DESCRIPTION = "FineTune(MyTaxi) configuration"
CFG.RUNNER = ForecastRunner
CFG.DATASET_CLS = ForecastDataset
CFG.DATASET_NAME = "MyTaxi"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "TaxiEnPropose_DeTMetaConvSConv"
...
from model_setting.pre_train.TaxiProposeMAE import CFG as BackBone

CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "backbone_path": "Taxi_PreTrain.pt",
